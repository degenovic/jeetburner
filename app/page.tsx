                ...
                <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4">
                  ...
                  <div className="flex items-center">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 text-purple-400 flex-shrink-0">
                  ...
                  {/* Arrow 1 */}
                  <div className="text-gray-600 mx-2 sm:mx-4">
                  ...
                  <div className="flex items-center">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-300 text-sm">Scan Empty Accounts</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 text-pink-400 flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
